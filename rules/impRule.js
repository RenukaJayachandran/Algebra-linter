...
var Rule = /** @class */ (function (_super) {
    ...
    Rule.FAILURE_STRING = "inga daw!!!! damo da";
    return Rule;
...
var NoImportsWalker = /** @class */ (function (_super) {
    ...
    NoImportsWalker.prototype.visitDoStatement = function (n) {
        if (n.expression.kind === ts.SyntaxKind.FalseKeyword) {
            this.addFailure(this.createFailure(n.getStart(), n.getWidth(), 'Damo hacked daw1'));
            _super.prototype.visitDoStatement.call(this, n);
        }
    };
    NoImportsWalker.prototype.visitPropertyAccessExpression = function (n) {
        if (n.name.text === 'map') {
            console.log('expr daw!', n.expression);
